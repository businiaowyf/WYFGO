...
import (
	...
	"github.com/BLHT/HT_GOGO/gotcp/tcpfw/include/ht_user"
...
func main() {
	...
	head := &common.HeadV2{Cmd: uint32(ht_user.ProtoCmd_CMD_GET_USERINFO), Len: uint32(tcpfw.EmptyPacktV2Len), Uid: uint32(uid)}
